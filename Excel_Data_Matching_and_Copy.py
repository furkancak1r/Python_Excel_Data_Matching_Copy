...
file_path = "C:\\Users\\furkan.cakir\\Desktop\\FurkanPRS\\Kodlar\\SSH\\SSH Exceller\\old.xlsx"
...
if os.path.exists(file_path):
    try:
        ...
        fixidesk_data = {}
        logo_data = {}
        fixidesk_range = worksheet.Range("F:F")
        ...
        for fixidesk_value, fixidesk_row in fixidesk_data.items():
            if fixidesk_value in logo_data:
                ...
                worksheet.Cells(fixidesk_row, 8).Value = result_sheet.Cells(logo_row, 2).Value
                # Get the value from logo C and write it to fixidesk D
                worksheet.Cells(fixidesk_row, 7).Value = result_sheet.Cells(logo_row, 1).Value
